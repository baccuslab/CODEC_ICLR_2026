...
directory= f'/data/codec/h5s/int_grad_top_1_True_{model_type}_{layer_type}_steps_10/'
TYPES = [['activations', 'sum'], ['contributions', 'positive']]
...
for pair in TYPES:
    ...
    for LAYER_IDX in range(num_layers)[::-1]:
        ...
        # syn = bic.SemanticAnalyzer('/data/hierarchy_metadata/semantic_indices.json')
        # mask_matrix, mask_labels = syn.get_all_semantic_masks(targets)
